...
class SelectOption {
    ...
    set value(value) {
        ...
        this.select.selectedIndex = options.findIndex((option) => option.value === value);
    }
}
 ...
 */
const buildInfo = {
    versionNumber: "0.3.0-nightly.2026.6.3",
    versionName: "0.3.0-nightly.2026.6.3",
    versionChannel: "nightly",
    buildDate: "2026-06-03T00:45:13.104Z",
    commitHash: "97a6da211c89813a5f3a4b01a48492e4e148ab58",
};
